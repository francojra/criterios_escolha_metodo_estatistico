...
-   **Modelos multidimensionais**
    ...
    -   **Pré-diagnósticos**: diversos, a depender do método. Ex. normalidade multivariada para MANOVA, esfericidade (variância-covariância) de Bartlett para Factor Analysis (FA).
